...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-primary-700 via-primary-600 to-secondary-600 text-white">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-neutral-500">Book your stay</p>
              </div>
            </Link>

            <Link
              to="/threads"
              className="flex items-center gap-3 p-4 rounded-xl bg-neutral-50 hover:bg-blue-50 transition-colors group"
            >
              <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center">
                <MessageSquare className="w-6 h-6 text-blue-600" />
              </div>
              <div>
                <p className="font-semibold text-neutral-900 group-hover:text-blue-700">
                  Message Us
                </p>
      ...
      <section className="py-16 bg-primary-700 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/80 mb-8 max-w-xl mx-auto">
            Join thousands of satisfied residents who have found their perfect space at Windsor Residence.
          </p>
          <div className="flex justify-center gap-4">
            <Link to="/register" className="btn bg-white text-primary-700 hover:bg-neutral-100">
              Get Started
            </Link>
            <Link to="/search" className="btn border-2 border-white text-white hover:bg-white/10">
              Explore Rooms
            </Link>
          </div>
        </div>
